...
*** timer_settime with tv_nsec 1000000000 unexpectedly succeeded");
  ...
  it.it_interval.tv_nsec = 200 * 1000 * 1000;
  ...
  it.it_value.tv_nsec = 200*1000*1000;
  it.it_interval.tv_nsec = 300*1000*1000;
  ...
  it.it_value.tv_nsec = 300*1000*1000;
  it.it_interval.tv_nsec = 400*1000*1000;
  if (timer_settime (timer_sig1, 0, &it, NULL) != 0)
    {
